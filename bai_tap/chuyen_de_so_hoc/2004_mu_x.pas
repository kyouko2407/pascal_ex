...
begin
    if n = 0 then tinh_x_mu_n := 1 
        ...
        begin    
            ...
            if n mod 2 = 0 then tinh_x_mu_n := sol * sol  //Nếu n chẵn thì bình phương thành x^n rồi mod 29
            else tinh_x_mu_n := sol * sol * x; //Tương tự với n lẻ 
        end;
end;
...
begin
    ...
    s_2 := 
    ((tinh_x_mu_n(2,2*x+1) - 1) mod 29) mod 29;
